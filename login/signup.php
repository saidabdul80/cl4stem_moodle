...
<script>
    window.onload = function(){
        ...
        document.querySelector("form").style.border="1px solid #ccc";
        document.querySelector("form").style.borderRadius="5px";
        document.querySelector("form").style.padding="15px";
        document.querySelector("form").classList.add('w-100');
        document.querySelectorAll("input").forEach(function(item){
            item.classList.add('w-100');
        })
        document.querySelector("#page").style.padding="0";
        document.querySelector("[data-region='drawer-toggle']").style.visibility= "hidden";
        
        document.querySelector("#page-content").classList.add('w-100');
        $(document).ready(function(){
            $(".card-title")[0].html();
            $(".card-title").html(`
            <div class="toggle-form">
            <span class="text">Already have an TISSx account?</span>
